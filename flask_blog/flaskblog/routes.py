...
def save_picture(img):
    ...
    file_path=random_hex+f_ext
    img_path=os.path.join(app.root_path,'static/profile_pics',file_path)
...
def account():
    ...
    if form.validate_on_submit():
        if form.profile_pic.data:
            img_path=save_picture(form.profile_pic.data)
            current_user.image_file=img_path
